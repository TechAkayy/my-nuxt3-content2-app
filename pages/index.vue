...
<template>
	<div>
		<Showcase> <Extras /> </Showcase><Features /><PageContent>
			<h2>Get Started With Iles</h2>
			<p>
				Get a new Iles project up and running locally with our helpful
				create-iles CLI wizard!
			</p>
			<Tabs client:visible />
